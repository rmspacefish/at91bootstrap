...
ifeq ($(CONFIG_SCLK_INTRC),y)
CPPFLAGS += -DCONFIG_SCLK_INTRC
endif
...
CPPFLAGS += -DCONFIG_CRYSTAL_24_000MHZ
endif
...
ifeq ($(CONFIG_CPU_CLK_800MHZ),y)
CPPFLAGS += -DCONFIG_CPU_CLK_800MHZ
endif

ifeq ($(CONFIG_CPU_CLK_1000MHZ),y)
CPPFLAGS += -DCONFIG_CPU_CLK_1000MHZ
endif
...
ifeq ($(CONFIG_CPU_HAS_PIO3),y)
CPPFLAGS += -DCONFIG_CPU_HAS_PIO3
endif
...
ifeq ($(CONFIG_SKIP_COPY_IMAGE), y)
CPPFLAGS += -DCONFIG_SKIP_COPY_IMAGE
ASFLAGS += -DCONFIG_SKIP_COPY_IMAGE
endif

ifeq ($(CONFIG_BKPT_NOTIFY_DONE), y)
CPPFLAGS += -DCONFIG_BKPT_NOTIFY_DONE
ASFLAGS += -DCONFIG_BKPT_NOTIFY_DONE
endif
...
ifeq ($(CONFIG_CPU_HAS_H32MXDIV), y)
CPPFLAGS += -DCONFIG_CPU_HAS_H32MXDIV
endif

ifeq ($(CONFIG_IOBC_IMAGE), y)
CPPFLAGS += -DCONFIG_IOBC_IMAGE
endif
